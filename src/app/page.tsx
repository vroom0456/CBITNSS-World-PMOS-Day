            ...
            <div className="stats-grid">
              <div className="stat-box reveal">
                <div className="stat-icon">
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C8A49F" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="5" r="2.5"/><path d="M12 7.5v5"/><path d="M7.5 13l4.5-2 4.5 2"/><path d="M4.5 19.5c2-2 4.5-3 7.5-3s5.5 1 7.5 3"/><path d="M3.5 16.5c1.5-1.5 4.5-2 8.5-2s7 .5 8.5 2"/></svg>
                </div>
              ...
              <div className="stat-box reveal">
                <div className="stat-icon">
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C8A49F" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                </div>
              ...
              <div className="stat-box reveal">
                <div className="stat-icon">
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C8A49F" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                </div>
